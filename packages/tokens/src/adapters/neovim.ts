...
const GROUPS: readonly HlSpec[] = [
  ...
  { group: "TelescopePromptBorder", fg: "border.subtle", bg: "surface.selected" },
  ...
  // snacks.nvim
  { group: "SnacksNormal", fg: "text.primary", bg: "surface.raised" },
  { group: "SnacksNormalNC", fg: "text.primary", bg: "surface.raised" },
  { group: "SnacksWinBar", fg: "accent.primary", bg: "surface.raised", style: ["bold"] },
  { group: "SnacksBackdrop", bg: "surface.canvas" },
  { group: "SnacksPicker", fg: "text.primary", bg: "surface.raised" },
  { group: "SnacksPickerNormal", fg: "text.primary", bg: "surface.raised" },
  { group: "SnacksPickerList", fg: "text.primary", bg: "surface.raised" },
  { group: "SnacksPickerInput", fg: "text.primary", bg: "surface.selected" },
  { group: "SnacksPickerPreview", fg: "text.primary", bg: "surface.raised" },
  { group: "SnacksPickerBox", fg: "text.primary", bg: "surface.raised" },
  { group: "SnacksPickerBorder", fg: "border.subtle", bg: "surface.raised" },
  { group: "SnacksPickerTitle", fg: "accent.primary", bg: "surface.raised", style: ["bold"] },
  { group: "SnacksPickerInputBorder", fg: "border.subtle", bg: "surface.selected" },
  { group: "SnacksPickerInputTitle", fg: "surface.canvas", bg: "accent.primary", style: ["bold"] },
  { group: "SnacksPickerCursorLine", bg: "surface.selected" },
  ...
  // Regular guides use border.faint (rain pre-blended into the canvas at
  // 40%, matching Inkdrop's alpha borders) so they recede; only the current
  // scope keeps border.subtle.
  { group: "SnacksIndent", fg: "border.faint" },
  { group: "SnacksIndentChunk", fg: "border.faint" },
  { group: "SnacksIndentScope", fg: "border.subtle" },
  { group: "IblIndent", fg: "border.faint" },
  { group: "IblWhitespace", fg: "border.faint" },
  { group: "IblScope", fg: "border.subtle" },
  { group: "IndentBlanklineChar", fg: "border.faint" },
  ...
  { group: "WhichKeyBorder", link: "FloatBorder" },
  ...
  { group: "NeoTreeIndentMarker", fg: "border.faint" },
  // nvim-cmp + blink.cmp
  ...
  { group: "BlinkCmpMenuSelection", link: "PmenuSel" },
  { group: "BlinkCmpLabel", fg: "text.primary" },
  { group: "BlinkCmpLabelMatch", fg: "accent.primary", style: ["bold"] },
  { group: "BlinkCmpLabelDescription", fg: "text.secondary" },
  { group: "BlinkCmpSource", fg: "text.secondary" },
  { group: "BlinkCmpKind", fg: "accent.secondary" },
  { group: "BlinkCmpKindWindsurf", fg: "status.info" },
  { group: "BlinkCmpDoc", link: "NormalFloat" },
  { group: "BlinkCmpDocBorder", link: "FloatBorder" },
  { group: "BlinkCmpSignatureHelp", link: "NormalFloat" },
  { group: "BlinkCmpSignatureHelpBorder", link: "FloatBorder" },
  // flash
