...
```
ipm install hue-cung-theme
```

Or open **Preferences → Plugins**, search for `hue-cung-theme`, and install
...
- **Huế Cung** — light, this one
- [Huế Hương](https://my.inkdrop.app/plugins/hue-huong-theme) — dark
