...
```
ipm install hue-huong-theme
```

Or open **Preferences → Plugins**, search for `hue-huong-theme`, and install
...
- [Huế Cung](https://my.inkdrop.app/plugins/hue-cung-theme) — light
- **Huế Hương** — dark, this one
- [Huế Mưa](https://my.inkdrop.app/plugins/hue-mua-theme) — dark
